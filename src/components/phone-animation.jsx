  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative h-96 w-56 md:w-64 md:h-[439px] lg:w-80 lg:h-[548px] rounded-[24px] border-2 border-b-4 border-r-4 border-white border-l-neutral-200 border-t-neutral-200 bg-neutral-900 p-1 pl-[3px] pt-[3px]"
      >
        <HeaderBar />
        <Screen />
      </motion.div>
